/*Go supports anonymous functions (https://en.wikipedia.org/wiki/Anonymous_function), which can form closures. (https://en.wikipedia.org/wiki/Closure_(computer_science))
